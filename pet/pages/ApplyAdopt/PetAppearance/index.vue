<template>
  <view class="pet-image">
    ...
    <img
      v-else
      src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-f46f8a1d-9332-4f0e-9666-910073387c9b/41fba3c6-0570-4834-8f51-e88c0d208e33.png"
      class="already"
    />
    <swiper
      class="swiper"
    ...
    >
      <swiper-item v-for="image in petInfo.img" :key="image.fileID">
        <image :src="image.url" class="image" mode="aspectFill"></image>
      </swiper-item>
    </swiper>
