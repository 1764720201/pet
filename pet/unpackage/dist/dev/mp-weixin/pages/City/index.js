...
var pages_City_citys_citys = require("./citys/citys.js");
const citySelect = () => "../../components/city-select/city-select.js";
const _sfc_main = {
  data() {
    return {
      location: {},
  ...
  onLoad() {
    ...
    setTimeout(() => {
      ...
      this.obtainCitys = pages_City_citys_citys.citys;
    }, 100);
  },
  methods: {
    cityClick(item) {
...
const _easycom_city_select = () => "../../components/city-select/city-select.js";
if (!Math) {
  _easycom_city_select();
}
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.sr("citys", "a58e5cec-0"),
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/yzc/Desktop/pet/pages/City/index.vue"]]);
