...
if (!Math) {
  (_easycom_tui_icon + _easycom_uni_dateformat + _easycom_uni_popup_dialog + _easycom_uni_popup)();
}
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const getComment = async () => {
      await db.collection("comment").where(`found_id=='${foundInfo._id}'&&comment_type==2`).get().then((res) => {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        v: common_vendor.f(commentList.value, (comment, k0, i0) => {
          return {
            ...
            e: common_vendor.t(comment.comment),
            f: comment._id
          };
        }),
