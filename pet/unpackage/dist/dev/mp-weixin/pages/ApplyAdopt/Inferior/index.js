...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    const goChat = () => {
      if (petInfo.value.user_id == userInfo.uid) {
        common_vendor.index.showToast({
          title: "\u4E0D\u80FD\u54A8\u8BE2\u81EA\u5DF1"
        });
      } else {
        common_vendor.index.navigateTo({
          url: `/pages/Chat/index?id=${petInfo.value.user_id}`
        });
      }
    };
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Users/yzc/Desktop/\u65B0\u5EFA\u6587\u4EF6\u5939/pet/pet/pages/ApplyAdopt/Inferior/index.vue"]]);
