...
if (!Array) {
  ...
  (_easycom_uni_icons2 + _easycom_tui_icon2 + _easycom_uni_dateformat2 + _easycom_uni_popup_dialog2 + _easycom_uni_popup2)();
}
...
if (!Math) {
  (_easycom_uni_icons + _easycom_tui_icon + _easycom_uni_dateformat + Poster + _easycom_uni_popup_dialog + _easycom_uni_popup)();
}
...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    common_vendor.watch(() => petInfo.value._id, () => {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        e: common_vendor.t(common_vendor.unref(petInfo).pet_name),
        f: common_vendor.t(common_vendor.unref(petInfo).age),
        g: common_vendor.t(common_vendor.unref(petInfo).variety),
        h: common_vendor.t(common_vendor.unref(petInfo).gender),
        i: common_vendor.t(common_vendor.unref(petInfo).city[1]),
        j: common_vendor.t(common_vendor.unref(petInfo).city[2]),
        k: common_vendor.t(common_vendor.unref(petInfo).punch ? common_vendor.unref(petInfo).punch : "\u672A\u8BBE\u7F6E"),
        l: common_vendor.o(punch),
        m: common_vendor.p({
          name: "about-fill",
          size: 15,
          color: "#d78797"
        }),
        n: common_vendor.t(common_vendor.unref(petInfo).story),
        o: common_vendor.f(common_vendor.unref(petInfo).request, (request, k0, i0) => {
          return {
        ...
        t: common_vendor.sr(alertDialog, "911e2c18-5", {
          "k": "alertDialog"
        }),
        v: common_vendor.p({
          type: "dialog"
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-911e2c18"], ["__file", "C:/Users/yzc/Desktop/\u65B0\u5EFA\u6587\u4EF6\u5939/pet/pet/pages/ApplyAdopt/PetInformation/index.vue"]]);
