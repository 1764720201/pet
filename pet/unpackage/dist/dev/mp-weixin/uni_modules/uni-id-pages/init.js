...
async function uniIdPageInit() {
  if (debug) {
    ...
    if (list.length) {
      console.error(`\u9519\u8BEF\uFF1A\u524D\u7AEF\u542F\u7528\u7684\u767B\u5F55\u65B9\u5F0F:${list.join("\uFF0C")};\u6CA1\u6709\u5728\u670D\u52A1\u7AEF\u5B8C\u6210\u914D\u7F6E\u3002\u914D\u7F6E\u6587\u4EF6\u8DEF\u5F84\uFF1A"/uni_modules/uni-config-center/uniCloud/cloudfunctions/common/uni-config-center/uni-id/config.json"`);
    }
  }
  ...
  if (common_vendor.pn.onRefreshToken) {
    common_vendor.pn.onRefreshToken(() => {
