...
var uni_modules_uniIdPages_common_loginSuccess = require("../../common/loginSuccess.js");
...
const _sfc_main = {
  ...
  methods: {
    ...
    login(params, type) {
      ...
      uniIdCo[action](params).then((result) => {
        ...
        if (type == "weixin" && result.type == "register") {
          uni_modules_uniIdPages_common_loginSuccess.loginSuccess(__spreadProps(__spreadValues({}, result), {
            showToast: false,
            autoBack: false
          }));
          return this.$refs.userProfile.open(result.uid);
        }
        uni_modules_uniIdPages_common_loginSuccess.loginSuccess(result);
      }).catch((e) => {
        console.log(e);
    ...
    doUserProfileNext() {
      try {
        uni_modules_uniIdPages_common_loginSuccess.loginSuccess();
      } catch (e) {
        console.log(e);
      }
    },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.sr("userProfile", "001890bf-0"),
    c: common_vendor.o($options.doUserProfileNext)
  };
}
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "C:/Users/yzc/Desktop/\u65B0\u5EFA\u6587\u4EF6\u5939/pet/pet/uni_modules/uni-id-pages/components/uni-id-pages-fab-login/uni-id-pages-fab-login.vue"]]);
