...
const _sfc_main = {
  ...
  data() {
    return {
      ...
      phone: "",
      focusPhone: false,
      logo: "https://vkceyugu.cdn.bspapp.com/VKCEYUGU-f46f8a1d-9332-4f0e-9666-910073387c9b/24f2313e-bd32-4feb-b647-f39ed409fae1.png"
    };
  },
  computed: {
    async loginTypes() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: $options.imgSrc,
    e: common_vendor.sr("agreements", "3d746ff5-0"),
    f: common_vendor.p({
      scope: "register"
    })
  } : {
    ...
    k: common_vendor.sr("agreements", "3d746ff5-2"),
    l: common_vendor.p({
      scope: "register"
    }),
    m: common_vendor.o((...args) => $options.toSmsPage && $options.toSmsPage(...args))
  }, {
    n: common_vendor.sr("uniFabLogin", "3d746ff5-3")
  });
}
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-3d746ff5"], ["__file", "C:/Users/yzc/Desktop/\u65B0\u5EFA\u6587\u4EF6\u5939/pet/pet/uni_modules/uni-id-pages/pages/login/login-withoutpwd.vue"]]);
