...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    common_vendor.watch(() => where.value, (newValue) => {
          ...
          return common_vendor.e({
            ...
            c: common_vendor.f(data, (inApply, k1, i1) => {
              return common_vendor.e({
                ...
                d: "2bc3db4c-2-" + i0 + "-" + i1 + ",2bc3db4c-0",
                e: common_vendor.p({
                  status: "loading"
                })
              } : {}, hasMore && !loading ? {
                f: "2bc3db4c-3-" + i0 + "-" + i1 + ",2bc3db4c-0",
                g: common_vendor.p({
                  status: "more"
                })
              } : !hasMore && !loading ? {
                h: "2bc3db4c-4-" + i0 + "-" + i1 + ",2bc3db4c-0",
                i: common_vendor.p({
                  status: "noMore"
                })
              } : {}, {
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-2bc3db4c"], ["__file", "C:/Users/yzc/Desktop/pet/components/Tab/Apply/index.vue"]]);
