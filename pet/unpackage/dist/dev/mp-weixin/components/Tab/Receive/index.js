...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  ...
  setup(__props) {
    ...
    common_vendor.watch(() => state.value, () => {
      apply = [
              ...
              return common_vendor.e({
                ...
                b: common_vendor.f((_c = receive == null ? void 0 : receive._id) == null ? void 0 : _c.apply, (apply2, k2, i2) => {
                  return common_vendor.e(common_vendor.unref(state) == "\u7533\u8BF7\u4E2D" ? {
                    ...
                    m: common_vendor.o(($event) => goChat(apply2.user_id)),
                    n: common_vendor.o(($event) => goProposerDetail(apply2._id))
                  }, common_vendor.unref(state) == "\u7533\u8BF7\u4E2D" ? {
                    o: common_vendor.o(($event) => allowAdopt(apply2._id, apply2.adopt_id))
                  } : {}, common_vendor.unref(state) == "\u7533\u8BF7\u4E2D" ? {
                    p: common_vendor.o(($event) => refuseAdopt(apply2._id, apply2.adopt_id))
                  } : {}, {
                    q: apply2._id
                  });
                }),
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-70db907e"], ["__file", "C:/Users/yzc/Desktop/\u65B0\u5EFA\u6587\u4EF6\u5939/pet/pet/components/Tab/Receive/index.vue"]]);
