          ...
          return common_vendor.e({
            ...
            c: common_vendor.f(data, (petInfo, k1, i1) => {
              return common_vendor.e({
                ...
                b: petInfo.img[0].path,
                c: common_vendor.t(petInfo.petName),
                d: common_vendor.t(petInfo.gender == "\u7537\u751F" ? "\u2642" : "\u2640"),
                e: common_vendor.t(petInfo.variety),
                f: common_vendor.f(petInfo.medical, (med, k2, i2) => {
                  return {
                    a: common_vendor.t(med)
                  };
                }),
                g: common_vendor.t(petInfo.city[1]),
                h: common_vendor.t(petInfo.city[2]),
                i: "eec1dd56-1-" + i0 + "-" + i1 + ",eec1dd56-0",
                j: common_vendor.p({
                  date: petInfo.issueTime,
                  format: "yyyy-MM-dd hh:mm:ss"
                }),
                k: common_vendor.o(($event) => goPetInfo(petInfo), petInfo._id),
                l: petInfo._id
              });
            })
          }, {
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-eec1dd56"], ["__file", "C:/Users/yzc/Desktop/\u65B0\u5EFA\u6587\u4EF6\u5939/pet/pet/components/PetList/index.vue"]]);
