...
export default class DrawPoster {
	constructor(options) {
		const { 
			...
			drawTipsText = '绘制中...', exportImageTips = '导出图片中...',
	...
	async setAllCallBack(params) {
		...
		if (type === 'text') {
			...
			const textArr = commonDrawMethods.computedFontTextLineHeight(x, y, w, text, textIndent, lastWidth, font, line, textAlign, windowAlign, color)
